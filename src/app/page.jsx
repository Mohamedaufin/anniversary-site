...
const ANNIVERSARY_DATE = "2025-08-23T00:00:00"
        ...
        {loading ? (
          ...
          <>
            ...
            >
              ...
              >
                <p className="text-lg font-medium"> Piriyamaanavaluku, En Piriyaamana Kadhal </p>
                <p className="text-lg font-medium">❤️ En Piriyaadha Kadhal ❤️</p>
              </motion.footer>
            </motion.div>
          </>
        )}
